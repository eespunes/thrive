...
Workspace _ws() {
  ...
  month.blocks['home'] = [
    ...
    ExpenseItem.fromJson({
      'id': 'later',
      'label': 'Insurance',
      // Non-numeric marker: no due day, so this bill never counts towards
      // "due today" regardless of which calendar day the suite runs on (a
      // fixed '28' made the test date-flaky at the end of a month).
      'marker': 'end',
      'amount': 50,
      'paid': false,
      'account': 'shared',
