            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Switch(
                    key: const ValueKey('cal-manage-kitchen-enabled'),
                    value: s.kitchenEnabled,
                    onChanged: (_) => setState(() => s.toggleKitchenEnabled()),
            ...
            if (members.isNotEmpty) ...[
              ...
              for (final m in members)
                Padding(
                  padding: const EdgeInsets.only(bottom: 8),
                  child: Container(
                    key: ValueKey('cal-manage-picmode-row-${m.id}'),
                    padding: const EdgeInsets.symmetric(
                      horizontal: 12,
                      vertical: 11,
                    ),
                    ...
                    child: Row(
                      children: [
                        ...
                        Switch(
                          key: ValueKey('cal-manage-picmode-${m.id}'),
                          value: s.pictureModeFor(m.id),
                          onChanged: (v) =>
                              setState(() => s.setPictureMode(m.id, v)),
